 ...
 * @date 2022-11-23
 * 
 * @copyright Copyright (c) M.Busser 2022
 * 
 */
...
class I2CDevice
{
  public:
    ...
    /**
     * @brief If true, the data will immediately be written to the bus after every bit change
     *        This behavior is like the previously used lib works.
     * 
     * @param auto [true|false]
     */
    void autoWrite( bool doAuto );
