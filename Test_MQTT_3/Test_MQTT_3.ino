...
void initTopics() {
  ...
  allTopics[4].topic = "T4EU/DE/IT";   allTopics[3].adr = 39;
  allTopics[5].topic = "T4EU/DE/IR";   allTopics[3].adr = 35;   //353
  allTopics[6].topic = "T4EU/DE/LT";   allTopics[4].adr = 37;   //370
  allTopics[7].topic = "T4EU/DE/UA";   allTopics[4].adr = 38;   //380
}
